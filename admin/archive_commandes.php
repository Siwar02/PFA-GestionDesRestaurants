	 ...
	 <div class="market-updates">
			<div class="col-md-4 market-update-gd">
				<div class="market-update-block clr-block-4">
					...
					<?php 
                        $sql = "SELECT count(*) as allCommandes from commande JOIN foods
                         ON commande.id_food=foods.id JOIN restaurant ON foods.restaurant_id=restaurant.id 
                         JOIN admins on restaurant.id=admins.id_restaurant where commande.archive='1'";
                        $stmt = $db->prepare($sql);
                        $stmt->execute();
	...
	<div class="col-md-12 chit-chat-layer1-left">
               <div class="work-progres">
                            ...
                            <div class="table-responsive">
                              ...
                              <?php 
                                    $i=1;
                                    $sql2 ="SELECT user.username,foods.name,foods.price,commande.quantity,
